...
headers_install: __headers
	...
	$(Q)$(MAKE) $(hdr-inst)=techpack/audio/include/uapi dst=techpack/audio/4.0/include
...
headers_check: headers_install
	...
	$(Q)$(MAKE) $(hdr-inst)=techpack/audio/include/uapi dst=techpack/audio/4.0/include HDRCHECK=1
